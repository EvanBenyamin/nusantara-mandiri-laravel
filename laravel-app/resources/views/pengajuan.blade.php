...
@section ('body')
    ...
    <div class="container hidden">
      @csrf
      <form class="user mt-5" action="{{route('postLogin')}}" method="post">
            <!-- 2 column grid layout with text inputs for the first and last names -->
            <div class="row mb-4">
              <div class="col">
                <label class="form-label" for="">Nama Lengkap</label>
                <div data-mdb-input-init class="form-outline">
                  <input type="text" id="nama" class="form-control mt-2" />
                </div>
              </div>
              <div class="col">
                <label class="form-label" for="">Jenis Kelamin</label>
                <div data-mdb-input-init class="form-outline">
                  <select id="jenis_kelamin" class="form-select form-select-lg" aria-label=".form-select-lg example">
          ...
          <div class="row mt-3">
              <div class="col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter phone number" pattern="\+62 [0-9]{3}-[0-9]{2}-[0-9]{3}">
                </div>
                  <small id="nomor_telepon" class="form-text text-muted">Format: +62-8XX-XXXX</small>
              </div>
          ...
          <div class="row">
            ...
            <select class="selectpicker col-lg-12" multiple id="jaminan" data-placeholder="Choose anything" multiple>
                <option>KTP</option>
